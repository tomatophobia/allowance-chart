...
object DaishinParserFixture {
  ...
  object mergeEntryTest {
    ...
    val expectedBuy: DaishinEntry = DaishinEntry(
      LocalDate.of(2020, 12, 17),
      "해외증권장내매매",
      Some(Currency.USD),
      Some(200.78),
    ...
    val dividedSell: List[DaishinEntry] = List(
      DaishinEntry(
        LocalDate.of(2021, 3, 15),
        "해외증권장내매매",
        Some(Currency.USD),
    ...
    val expectedSell: DaishinEntry = DaishinEntry(
      LocalDate.of(2021, 3, 15),
      "해외증권장내매매",
      Some(Currency.USD),
      Some(249.79),
  ...
  object wholeProcessTest {

    val rawString: List[Seq[String]] = List(
      List(
        "2020.10.12",
        "입금",
        "",
    ...
    val records: List[TransactionRecord] = List(
      ...
      TransactionRecord.Buy(
        ...
        "해외증권장내매매",
        Money.usd(200.78),
        Holding(Stock("DKNG", Nation.USA), Money.usd(50.20), 5),
        "현금매수",
        Money.usd(0.16)
      ),
      TransactionRecord.Dividend(
